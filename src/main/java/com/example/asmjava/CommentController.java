...
public class CommentController implements Initializable {
    ...
    void getFile(MouseEvent event){
        ...
        try {
            Date date = new Date(new File("C:\\Users\\Hoang Hai Duy\\IdeaProjects\\Employee-Management").lastModified());
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        fileChooser.setInitialDirectory(new File("C:\\Users\\Hoang Hai Duy\\IdeaProjects\\Employee-Management"));
    }
